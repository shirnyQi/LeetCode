...
// timeout
func minPatches_timeout(nums []int, n int) int {
	var res int
...
func TestName(t *testing.T) {
	...
	fmt.Println(minPatches_timeout([]int{1, 3}, 6))      // 1
	fmt.Println(minPatches_timeout([]int{1, 5, 10}, 20)) // 2
	fmt.Println(minPatches_timeout([]int{1, 2, 2}, 5))   // 0
}
